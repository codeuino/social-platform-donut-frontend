...
<nav class="nav-container navbar navbar-default navbar-fixed-top">
      ...
      <ul class="nav navbar-nav navbar-right test">
        ...
        <ul>
            ...
            <li id="noti_Container">
                ...
                <div id="noti_Button"><i style="color:#e2e2e2;font-size:3rem;" class="material-icons">add_alert</i></span></div>    

                <!--THE NOTIFICAIONS DROPDOWN BOX.-->
                <div id="notifications">
                    <h3>Notifications</h3>
                    <div style="height:300px;">
                      <div style="margin-top:30%; margin-left: 30%;" class="notificationscontent"><p class="lead">No new Notifications</p></div>
                    </div>
                    <div class="seeAll"><a href="#"><span class="seeallspan">See All</span></a></div>
                </div>
            </li>
  ...
  <div class="blog-header">
      <div class="container">
        <h1 class="blog-title">Readers Feed <button type="button" class="btn btn-default btn-lg write" data-toggle="modal" data-target="#myModaleditor"><span id="writelogo" class="glyphicon glyphicon-pencil"></span> Start Writing</button></h1>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-9 blog-main">
            ...
            <?php include('fetch.php'); $real_user= $username; get_articles($real_user); ?>
        ...
        <div class="col-sm-3 offset-sm-1 blog-sidebar">
          <div class="sidebar-module sidebar-module-inset ">
            <h4>Trending <i class="material-icons icon-color">trending_up</i></h4>
          ...
          <div class="sidebar-module">
            <h4>Social Connects <i class="material-icons icon-color">supervisor_account</i></h4>
            <ol class="list-unstyled">
            <li><a href="#">No, Not Again </a></li>
            <li><a href="#" class="text-info">By Shubham Tripathi</a></li>
            <li><a href="#">The immortals of meluha</a></li>
