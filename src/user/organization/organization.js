              ...
              <div className="posts">
                ...
                <Card className="about-us">
                  <CardContent>
                    ...
                    <p className="short__desc">{description?.shortDescription || "Short details of organization"}</p>
                    <div className="subtitle">About us in details</div>
                    <p className="long__desc">{description?.longDescription || "Long description of the organization"}</p>
                  </CardContent>
                </Card>
              </div>
            )}
