...
import {makeStyles, Drawer, List, CssBaseline, Divider, Button, ListItem, ListItemIcon } from "@material-ui/core";
    ...
    <div className={classes.root}>
      ...
      >
        <div className={classes.toolbar}>
          ...
          >
            <img className="donut-logo" src={Donut} alt="L"></img>
          </Button>
        </div>
        ...
        <List>
          ...
          <ListItem button className={classes.divStyle}>
          ...
          <ListItem button className={classes.divStyle}>
            ...
            <Logout open={logout} onClose={cancel} />
            </ListItem>
        </List>
      </Drawer>
    </div>
