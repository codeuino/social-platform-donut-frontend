      ...
      <div className="navigation">
        <ListGroup>
          ...
          >
            ...
            <NavLink to="/dashboard" style={{ color: "#1A73E8" }}>
              <b>Dashboard</b>
            </NavLink>
          </ListGroup.Item>
          <ListGroup.Item className={this.props.posts ? "active" : "inactive"}>
            ...
            <NavLink to="/pinned-posts" style={{ color: "#1A73E8" }}>
              <b>Pinned Posts</b>
            </NavLink>
          </ListGroup.Item>
          <ListGroup.Item className={this.props.org ? "active" : "inactive"}>
            ...
            <NavLink to="/organization" style={{ color: "#1A73E8" }}>
              <b>Organization</b>
            </NavLink>
          </ListGroup.Item>
          <ListGroup.Item
          ...
          >
            ...
            <NavLink to="profile" style={{ color: "#1A73E8" }}>
              <b>Account</b>
            </NavLink>
          </ListGroup.Item>
