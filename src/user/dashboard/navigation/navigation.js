    ...
    return (
      <div className="navigation">
        <List className="list-group">
          <Link to="/dashboard">
            <ListItem button>
              <ListItemIcon className="donut-title">
                <DonutTitleSmall />
              </ListItemIcon>
            </ListItem>
          </Link>
          <Link to="/dashboard" className="route">
            <ListItem button className={this.props.dashboard ? "active" : "inactive"}>
              <ListItemIcon>
                <svg
                  width="18"
                  height="18"
          ...
          <Link to='/pinned-posts' className="route">
            <ListItem button className={this.props.posts ? "active" : "inactive"}>
              <ListItemIcon>
                <svg
                  width="20"
                  height="20"
              ...
              <span className="link-text">Pinned Posts</span>
            </ListItem>
          </Link>
          <Link to="/organization" className="route">
            <ListItem button className={this.props.org ? "active" : "inactive"}>
              <ListItemIcon>
                <svg
                  width="18"
                  height="18"
              ...
              <span className="link-text">Organization</span>
            </ListItem> 
          </Link>
          <Link to="/profile" className="route">
            <ListItem button className={this.props.profile ? "active" : "inactive"}>
              <ListItemIcon>
                <svg
                  width="18"
                  height="18"
          ...
          <Link to="/settings" className="route">
            <ListItem button style={divStyle2} className={this.props.settings ? "active" : "inactive"}>
              <ListItemIcon>
                <svg
                  width="18"
                  height="18"
          ...
          <ListItem button style={divStyle} onClick={() => this.setState({logout: true})}>
            <ListItemIcon>
          ...
          <ListItem button className="jitsi-box" onClick={() => this.setState({open: true})}>
            <ListItemText primary="Jitsi Meet" className="jitsi" />
          </ListItem>
