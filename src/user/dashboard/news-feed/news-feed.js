...
class NewsFeed extends Component {
  ...
  render() {
    ...
    let newsFeed = feed.map((newsItem, i) => {
      if (newsItem.type === "Project") {
        content = newsItem.eventImage ? (
          <div className="project-image-container">
            <img src={newsItem.eventImage} alt="text" />
            <div className="project-jumbotron">
              <div className="project-details">
                ...
                <div className="view-project-btn-container">
                  <Button className="view-project-btn text-center">
                    View Project
                  </Button>
                </div>
              </div>
      ...
      return (
        <div className="individual-post" key={newsItem._id}>
          {content}
            ...
            <div className="cta">
              ...
              >
                <Modal.Header
                  ...
                  style={borderStyle}
                >
                  <Modal.Title className="modal-title" style={borderStyle}>
