...
var all_comments = comments.map((comment)=>(
  ...
  <Col md={2}><img class="photo" src={comment.logo} alt="I"></img></Col>
  <Col md={10}><div className="contain"> 
    ...
    return (
      ...
      <div className="container">
        ...
        <div className="form-footer">
          <Button onClick={this.props.onHide} type="submit" className="savebtn">Post</Button>
        </div>
        </Form>
