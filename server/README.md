...
6. run this command to run on local
    ...
    node server.js
    ```
7. To use DB make config/credential.js file inside config folder and export the mongourl that you want to use their

```javascript
module.exports={
    db:'mongodb://localhost:27017/donut' //example URL
}
```
